...
Die globalen Variablen, welche die Ergebnisse der Experimente speichert, mussten nicht entfernt werden, da bereits 10, also eine für jeden Seed bestehen. Der Code wurde vereinfacht, da dem Array stattdessen eine weitere Dimension hinzugefügt wurde, welche spezifiziert, von welchem seed die Ergebnisse stammen. So wurde der Code lesbarer, und es ist gibt weiterhin getrennte Speichersegmente für verschiedene Threads.
